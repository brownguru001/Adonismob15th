...
export default async function OrderDetailPage({
  ...
  return (
    <div className="mx-auto max-w-3xl px-4 py-12 sm:px-6 lg:px-8">
      ...
      <div className="mt-6 rounded-xl border border-ink/10 p-6 text-sm">
      ...
      {order.address && (
        <div className="mt-6 rounded-xl border border-ink/10 p-6 text-sm text-ink/70">
          <p className="text-sm font-semibold uppercase tracking-wide text-ink/50">Delivery to</p>
