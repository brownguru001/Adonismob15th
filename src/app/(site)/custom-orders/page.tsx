...
export const metadata: Metadata = {
  title: "Custom Orders",
  description: "Submit a custom clothing order to ADONISMOB15TH — your design, our production.",
};
    ...
    <div className="mx-auto max-w-5xl px-4 py-12 sm:px-6 lg:px-8">
      ...
      <div className="mt-10 grid gap-10 lg:grid-cols-[1fr_320px]">
        {user ? (
          ...
          <div className="rounded-xl border border-ink/10 p-8 text-center">
            <p className="text-ink/70">Sign in to submit a custom order request.</p>
            <Link
              href="/login?callbackUrl=/custom-orders"
              className="mt-4 inline-block rounded-full bg-ink px-6 py-3 text-sm font-semibold text-bone"
            >
              Sign in
            </Link>
          </div>
