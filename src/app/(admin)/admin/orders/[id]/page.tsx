    ...
    <div className="max-w-4xl">
      ...
      <div className="mt-8 grid gap-6 lg:grid-cols-2">
        <div className="rounded-xl border border-bone/10 bg-ink-soft p-6">
          ...
          <div className="mt-3 border-t border-bone/10 pt-3 text-sm">
            <div className="flex justify-between text-bone/60"><span>Subtotal</span><span>{formatNaira(order.subtotal)}</span></div>
            <div className="flex justify-between text-bone/60"><span>Shipping</span><span>{formatNaira(order.shippingFee)}</span></div>
