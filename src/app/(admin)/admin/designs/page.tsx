    ...
    <div>
      ...
      <div className="mt-6 grid gap-6 lg:grid-cols-[1fr_360px]">
        <div className="space-y-3">
          {designs.map((d) => (
            <div key={d.id} className="flex items-center gap-4 rounded-xl border border-ink/10 bg-white p-4">
              <div className="relative h-16 w-16 shrink-0 overflow-hidden rounded-lg bg-bone-dim">
          ...
          {designs.length === 0 && <p className="text-ink/40">No designs yet.</p>}
        </div>
